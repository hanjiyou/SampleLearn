...
{
    public class CSharpCallLuaDemo02ILuaMap1Bridge : LuaBase, CSharpCallLuaDemo02.ILuaMap1
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new CSharpCallLuaDemo02ILuaMap1Bridge(reference, luaenv);
		}
		
		public CSharpCallLuaDemo02ILuaMap1Bridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
		
        
		int CSharpCallLuaDemo02.ILuaMap1.add(int a, int b)
		{
        ...
        int CSharpCallLuaDemo02.ILuaMap1.f1 
        {
        ...
        int CSharpCallLuaDemo02.ILuaMap1.f2 
        {
