...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public string __Gen_Delegate_Imp11(int p0, bool p1, out CSharpCallLuaDemo02.ValueClass1 p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
                ...
                p2 = (CSharpCallLuaDemo02.ValueClass1)translator.GetObject(L, errFunc + 2, typeof(CSharpCallLuaDemo02.ValueClass1));
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(CSharpCallLuaDemo02.MapDelegate))
			{
			    return new CSharpCallLuaDemo02.MapDelegate(__Gen_Delegate_Imp11);
			}
