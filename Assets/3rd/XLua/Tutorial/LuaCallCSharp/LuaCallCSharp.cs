...
public class LuaCallCSharp : MonoBehaviour
{
	...
	string script = @"
        function demo()
            ...
            testobj:CallEvent()
            testobj:TestEvent('-', lua_event_callback2)
			--testobj:CallEvent() TestEvent为空 不能执行 否则报错
...
namespace Tutorial
{
	...
	public class DerivedClass : BaseClass
	{
		...
		/// <summary>
		/// lua为C#委托添加方法:TestDelegate=TestDelegate+luaMethod
		/// </summary>
		...
		/// <summary>
		/// lua为C#事件添加方法： testobj:TestEvent('+', lua_event_callback1)
		/// </summary>
